...
pub(crate) fn add_release_into_database(
    ...
    let result = conn.query_one(
        "INSERT INTO releases (
            ...
            is_library, documentation_url, features, github_repo
         )
         VALUES (
            $1,  $2,  $3,  $4,  $5,  $6,  'in_progress', $7,
...
pub(crate) fn update_release_in_database(
    ...
    if result == 0 {
        failure::bail!("Updating unknown release {}", release_id);
    }
